...
SET "location1=D:\SteamLibrary\steamapps\common\Team Fortress 2\bin\captioncompiler.exe"
SET "location2=D:\SteamLibrary\steamapps\common\Team Fortress 2\bin\captioncompiler.exe"
