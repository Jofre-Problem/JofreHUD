Scheme
{
	...
	{		
		"DefaultFixedOutline" //edited by INsane 2010 for small netgraph font on all screen sizes
		{
            ...
            {
                "name"         "SF Alien Encounters" // Apple Mac OS "Verdana" (default) Best small font = "Georgia" Mac Installation location: /Library/Fonts and is default on Mac OS           
                "tall"         "17"               
                "weight"     "0"
                "range"         "0x0000 0x017F" //    Basic Latin, Latin-1 Supplement, Latin Extended-A
                "yres"         "1024 1199"
	...
	CustomFontFiles
	{
		...
		"132"
		{
			"font" "_jofrenew/font/SFAlienEncounters.ttf"
			"name" "SF Alien Encounters"
			"range"	"0x0000 0x017F"
		} 		 		
	}	
