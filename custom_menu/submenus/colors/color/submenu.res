				...
				"ColorButtons"
				{
					...
					"Primary"
					{
						...
						"Reset"
						{
							...
							"textAlignment"				"east"
							"font"						"newicons12"
							"command"					"engine jp_color_primary_clear"
							"actionsignallevel"			"6"
							"paintbackground"			"0"
					...
					"Positive"
					{
						...
						"Reset"
						{
							...
							"textAlignment"				"east"
							"font"						"newicons12"
							"command"					"engine jp_color_positive_clear"
							"actionsignallevel"			"6"
							"paintbackground"			"0"
							"defaultfgcolor_override"	"PrimaryT2"
							"armedfgcolor_override"		"Primary"
					...
					"Warning"
					{
						...
						"Reset"
						{
							...
							"textAlignment"				"east"
							"font"						"newicons12"
							"command"					"engine jp_color_warning_clear"
							"actionsignallevel"			"6"
							"paintbackground"			"0"
							"defaultfgcolor_override"	"PrimaryT2"
							"armedfgcolor_override"		"Primary"
					...
					"Negative"
					{
						...
						"Reset"
						{
							...
							"textAlignment"				"east"
							"font"						"newicons12"
							"command"					"engine jp_color_negative_clear"
							"actionsignallevel"			"6"
							"paintbackground"			"0"
							"defaultfgcolor_override"	"PrimaryT2"
							"armedfgcolor_override"		"Primary"
					...
					"Crosshair"
					{
						...
						"BodyText"
						{
							...
							"tall"					"15"
							"proportionaltoparent"	"1"
							"labelText"				"HUD custom crosshair color, etc..."
							"font"					"regular12"
							"fgcolor"				"PrimaryT2"
							"textinsetx"			"20"
							"useproportionalinsets"	"1"
						...
						"Reset"
						{
							...
							"textAlignment"				"east"
							"font"						"newicons12"
							"command"					"engine jp_color_crosshair_clear"
							"actionsignallevel"			"6"
							"paintbackground"			"0"
							"defaultfgcolor_override"	"PrimaryT2"
							"armedfgcolor_override"		"Primary"
					...
					"Neutral"
					{
						...
						"Reset"
						{
							...
							"textAlignment"				"east"
							"font"						"newicons12"
							"command"					"engine jp_color_neutral_clear"
							"actionsignallevel"			"6"
							"paintbackground"			"0"
							"defaultfgcolor_override"	"PrimaryT2"
							"armedfgcolor_override"		"Primary"
